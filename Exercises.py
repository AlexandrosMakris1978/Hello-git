...
# Pyramid
Create a program which asks the user for the number of floors and prints a symmetrical pyramid of '*' of equal floors. For examples for floors = 4 it prints:
   *
  ***
 *****
******* 
...
# FizzBuzz
Create the procedure FizzBuzz(n) which prints the numbers [1 - n] or Fizz if the number is a multiple of 3, Buzz if the number is a multiple of 5, or FizzBuzz if the number is a multiple of both 3 and 5. 
